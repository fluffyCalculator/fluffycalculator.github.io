    ...
    <div className="flex mt-5 shadow-md">
      <div
        className={clsx(
          ...
          "p-2 text-xs border border-solid border-prpl rounded rounded-r-none cursor-pointer select-none sm:text-base"
        )}
        onClick={handleClick}
        title="1"
      >
      ...
      <div
        className={clsx(
          window.daily_universe === 2
            ...
            : "bg-secondary text-primary",
          "p-2 text-xs border border-solid border-prpl rounded rounded-l-none cursor-pointer select-none sm:text-base"
        )}
        onClick={handleClick}
        title="2"
      >
